...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!perms.has("READ_MESSAGE_HISTORY"))
      return message.reply("Missing permission to read message history");
    if (!perms.has("ADD_REACTIONS"))
      return message.reply("Missing permission to add reactions");
    if (!perms.has("MANAGE_MESSAGES"))
      return message.reply("Missing permission to manage messages");
    if (!perms.has("EMBED_LINKS"))
      return message.reply("Missing permission to add embeds");
